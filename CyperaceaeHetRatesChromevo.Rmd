...
nodelabels(node = as.numeric(findMRCA(mytree, tips=c("Kyllingiella_microcephala","Cyperus_cuspidatus"), type=c("node"))), pch =24, col= '#28E2E5', bg = '#28E2E5', cex = 1)
...
nodelabels(node = as.numeric(findMRCA(mytree, tips=c("Cyperus_compressus","Cyperus_cyperoides"), type=c("node"))), pch =21, col= '#CD0BBC', bg = '#CD0BBC', cex = 1)
