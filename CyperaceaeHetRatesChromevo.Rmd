...
cn <- as.numeric(cn[,2])
## 0. format output
  pdf('./CyperaceaeHetRatesChromEvol.pdf', 6.69, 8.86)
...
mytree<-paintSubTree(mytree,node=as.numeric(findMRCA(mytree, tips=c("Cyperus_compressus","Cyperus_cyperoides"), type=c("node"))),stem=0.2,state=5)
